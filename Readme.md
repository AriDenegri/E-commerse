...
2. **Menús del programa:**
   - El programa tiene varios menús que permiten al usuario navegar y realizar acciones en la tienda:
     ...
     - **Menú del carrito (`menuCarrito`)**: Si los hay, muestra los productos en el carrito, el total a pagar, y ofrece opciones eliminar productos (uno por uno si es que hay mas de un mismo producto) o finalizar la compra.
...
- Eliminacion de duplicados y remplazo por la cantidad del producto añadido EJ:  *Antes: Libro, libro // Ahora: Libro X2.*
